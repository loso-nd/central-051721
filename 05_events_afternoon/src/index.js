...
const renderAnimal = function (animal) {
    ...
    span.textContent = `${animal.donations} Donated `
...
//     </div>
//     `
//    li.querySelector('.donate').addEventListener('click', () => {
//        li.querySelector('.donation-count').textContent = animal.donations+=10
//    })
...
function initialize() {
    ...
    animalData.forEach(renderAnimalHTML)
}
initialize()
